...
{
    public class CaracteristicaCuentaService : ICaracteristicaCuentaService
    {
        private readonly ICaracteristicaCuentaRepository _repository;
        private readonly IMensajeRespuestaRepository _mensajeRepository;

        public CaracteristicaCuentaService(ICaracteristicaCuentaRepository repository, IMensajeRespuestaRepository mensajeRepository)
        {
            _repository = repository;
            _mensajeRepository = mensajeRepository;
        }

        public async Task<Respuesta> ObtenerCaracteristicaCuentas()
        {
            ERespuesta codigoRespuesta = ERespuesta.OK;
            int codigoEvento = 0;

            (int codigo, IEnumerable<ComboStringDto> CaracteristicaCuentas) = await _repository.SelectCaracteristicaCuentas();
            ...
            return new Respuesta()
            {
                ...
                resultado = CaracteristicaCuentas,
