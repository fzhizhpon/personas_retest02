...
namespace Catalogo.Infrastructure.Repositories
{
    public class MonedaRepository : IMonedaRepository
    {
        ...
        public MonedaRepository(IConexion<OracleConnection> conexion, ILogger<MonedaRepository> logger,
        ...
        public async Task<(int, IEnumerable<ComboDto>)> SelectMonedas()
        {
            try
            {
                string keyRedis = "Monedas"; //LLave
                IEnumerable<ComboDto> monedas = null;
                monedas = _extensionCache.GetData<IEnumerable<ComboDto>>(keyRedis);
                ...
                if (monedas is null)
                {
                    using (var connection = _conexion.ObtenerConexion())
                    {
                        try
                        {
                            ...
                            string query = Queries.MonedaQuery.SelectMonedas(_esquema);
                        ...
                        {
                            _logger.LogError($"ERROR: Error en el metodo SelectMonedas, {ex}");
                ...
                return (CodigosLogicaInterna.CODIGO_GENERICO_OK_INTERNO, monedas);
            }
            catch (Exception ex)
            {
                _logger.LogError($"ERROR: Error en el metodo SelectMonedas, {ex}");
